...
public class AlertBuilder
{
	...
	private void initializeImages()
	{
		...
		InputStream infoResource = getClass().getResourceAsStream("/boundaries/images/info.png");
		if (infoResource != null) {
			s_infoImage = new Image(infoResource);
		}

		InputStream warningResource = getClass().getResourceAsStream("/boundaries/images/warning.png");
		if (warningResource != null) {
			s_warningImage = new Image(warningResource);
		}

		InputStream errorResource = getClass().getResourceAsStream("/boundaries/images/error.png");
